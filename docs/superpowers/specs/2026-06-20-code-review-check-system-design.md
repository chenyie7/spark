...
| `scripts/code_check/scanner.py` | Python | Java 文件扫描引擎，读取 yaml 执行匹配 |
| `scripts/code_check/reporter.py` | Python | 报告生成模块，JSON → Markdown 转换 |
| `scripts/code_check/cli.py` | Python | 命令行接口，click/argparse |
